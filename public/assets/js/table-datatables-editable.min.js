var TableDatatablesEditable = function() {
    var e = function() {
        ...
        function t(e, t) {
            var n = e.fnGetData(t),
                a = $(">td", t);
            a[0].innerHTML = '<input type="text" class="form_control input-small" name="s1" value="' + n[0] + '">',
            a[1].innerHTML = '<input type="text" class="form_control input-small" name="s2" value="' + n[1] + '">',
            a[2].innerHTML = '<input type="text" class="form_control input-small" name="s3" value="' + n[2] + '">',
            a[3].innerHTML = '<input type="text" class="form_control input-small" name="s4" value="' + n[3] + '">',
