...
class CommitteeApprovedCoordinators extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->markdown('committee::emails.committee_approved_coordinators', ['committee' => $this->committee]);
    }
