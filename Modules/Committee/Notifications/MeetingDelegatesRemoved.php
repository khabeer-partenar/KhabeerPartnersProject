...
class MeetingDelegatesRemoved extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject(__('committee::notifications.meeting_delegates_removed') . ' ' . $this->committee->subject)
            ->markdown('committee::emails.meeting_delegates_removed', ['committee' => $this->committee, 'meeting' => $this->meeting]);
    }
