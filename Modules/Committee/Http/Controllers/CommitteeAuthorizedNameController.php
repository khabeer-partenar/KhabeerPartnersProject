...
class CommitteeAuthorizedNameController extends UserBaseController
{
     ...
     * @return Response
     */
    public function index(Request $request, AuthorizedName $authorizedNames)
    {
     ...
     */
    public function export(Request $request, AuthorizedName $authorizedNames) 
    {
        return Excel::download(new AuthorizedListExport, 'list.xlsx');
        
    }

    public function printAuthorizedList(AuthorizedName $authorizedNames, Request $request)
    {
