...
للاطلاع على الرابط',
    ...
    'cancel_complmentary_meeting'  => ': تم تعديل الغاء الاستكمالي المقرر انعقاده في هيئة الخبراء يوم (:day) بتاريخ (:date) للمعاملة رقم (:number)  في صالة (:hall) للاطلاع علي الرابط ',
