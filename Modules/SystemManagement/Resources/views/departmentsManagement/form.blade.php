...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('telephone') ? ' has-error' : '' }}">
            ...
            {!! Form::label('telephone', __('systemmanagement::systemmanagement.departmentManagementTelephone'), ['class' => 'control-label']) !!}
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
            ...
            {!! Form::label('address', __('systemmanagement::systemmanagement.departmentManagementAddress'), ['class' => 'control-label']) !!}
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            {!! Form::label('email', __('systemmanagement::systemmanagement.departmentManagementEmail'), ['class' => 'control-label']) !!}
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('is_reference') ? ' has-error' : '' }}">
            ...
            {!! Form::label('is_reference', __('systemmanagement::systemmanagement.departmentManagementIsReference'), ['class' => 'control-label']) !!}
