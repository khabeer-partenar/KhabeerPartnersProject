...
class CoreSystemManagementAppsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $departmentsTypesId = App::create([
            ...
            'icon' => 'fa fa-bars', 'sort' => 2, 'parent_id' => $systemManagementAppId, 'frontend_path' => 'system-management/departments-types', 'is_main_root' => 1,
            'displayed_in_menu' => 1, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()
        ])->id;
        ...
        App::create([
            'resource_name' => $generalResourceName . '\DepartmentController@departments', 'name' => 'إدارة الجهات',
            'icon' => 'fa fa-bars', 'sort' => 3, 'parent_id' => $systemManagementAppId, 'frontend_path' => 'system-management/departments', 'is_main_root' => 1,
            'displayed_in_menu' => 1, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()
        ]);

        App::create([
            'resource_name' => $generalResourceName . '\DepartmentController@departmentsAuthorities', 'name' => 'إدارة إدارات الهيئة',
            'icon' => 'fa fa-bars', 'sort' => 4, 'parent_id' => $systemManagementAppId, 'frontend_path' => 'system-management/departments/authorities', 'is_main_root' => 1,
            'displayed_in_menu' => 1, 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()
        ]);
