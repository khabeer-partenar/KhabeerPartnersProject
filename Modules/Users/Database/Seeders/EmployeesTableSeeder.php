    ...
    public function run()
    {
        ...
        $usersData = [
            ...
            [
                ...
                'main_department_id' => '1', 'parent_department_id' => '2',
                'direct_department' => 3, 'is_super_admin' => 0, 'job_role_id' => 1,
                'created_at' => Carbon::now(), 'updated_at' => Carbon::now()
            ],
            ...
            [
                ...
                'main_department_id' => '1', 'parent_department_id' => '2',
                'direct_department' => 3, 'is_super_admin' => 0, 'job_role_id' => 2,
                'created_at' => Carbon::now(), 'updated_at' => Carbon::now()
            ],
            ...
            [
                ...
                'main_department_id' => '1', 'parent_department_id' => '2',
                'direct_department' => 3, 'is_super_admin' => 0, 'job_role_id' => 3,
                'created_at' => Carbon::now(), 'updated_at' => Carbon::now()
            ],
            ...
            [
                ...
                'main_department_id' => '1', 'parent_department_id' => '2',
                'direct_department' => 3, 'is_super_admin' => 0, 'job_role_id' => 4,
                'created_at' => Carbon::now(), 'updated_at' => Carbon::now()
            ],
            ...
            [
                ...
                'main_department_id' => '1', 'parent_department_id' => '2',
                'direct_department' => 3, 'is_super_admin' => 0, 'job_role_id' => 6,
                'created_at' => Carbon::now(), 'updated_at' => Carbon::now()
            ],
            ...
            [
                ...
                'main_department_id' => '1', 'parent_department_id' => '2',
                'direct_department' => 3, 'is_super_admin' => 0, 'job_role_id' => 7,
                'created_at' => Carbon::now(), 'updated_at' => Carbon::now()
            ],
