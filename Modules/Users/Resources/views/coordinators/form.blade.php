<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('parent_department_id') ? ' has-error' : '' }}">
            ...
            <select name="parent_department_id" id="parent_department_id" class="form_control select2 change-reference">
                <option value="0">{{ __('users::departments.choose a department') }}</option>
                @php
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('national_id') ? ' has-error' : '' }}">
            ...
            {!! Form::text('national_id', null, ['id' => 'national_id', 'class' => 'form_control accept_saudi_national_id_only']) !!}
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('phone_number') ? ' has-error' : '' }}">
            ...
            {!! Form::text('phone_number', null, ['id' => 'phone_number', 'class' => 'form_control accept_phone_numbers_only']) !!}
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            {!! Form::text('email', null, ['id' => 'email', 'class' => 'form_control accept_gov_email_only']) !!}
