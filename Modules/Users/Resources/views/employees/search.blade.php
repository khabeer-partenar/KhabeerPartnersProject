        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('user_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('employee_id', $employeesData, $employeesData, ['id' => 'employee_id', 'class' => 'form-control select2-search-employees']) !!}
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('direct_department_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('direct_department_id', $directDepartments, '', ['id' => 'direct_department_id', 'class' => 'form-control select2']) !!}
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('job_role_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('job_role_id', $rolesData, '', ['id' => 'job_role_id', 'class' => 'form-control select2']) !!}
