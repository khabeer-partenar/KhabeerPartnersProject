<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('main_department_id') ? ' has-error' : '' }}">
            ...
            {!! Form::label('main_department_id', __('users::employees.department_type'), ['class' => 'col-md-4 control-label']) !!}
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('parent_department_id') ? ' has-error' : '' }}">
            ...
            {!! Form::label('parent_department_id', __('users::employees.parent_department_id'), ['class' => 'col-md-4 control-label']) !!}
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
            ...
            {!! Form::label('name', __('users::employees.name'), ['class' => 'col-md-4 control-label']) !!}
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('phone_number') ? ' has-error' : '' }}">
            ...
            {!! Form::label('phone_number', __('users::employees.phone_number'), ['class' => 'col-md-4 control-label']) !!}
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            {!! Form::label('email', __('users::employees.email'), ['class' => 'col-md-4 control-label']) !!}
