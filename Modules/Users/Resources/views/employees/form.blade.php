<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('direct_department_id') ? ' has-error' : '' }}">
            ...
            <label for="direct_department_id" class="col-md-4 control-label">
                {{ __('users::employees.direct_department_id') }}
                <span style="color: red">*</span>
            </label>

            <div class="col-md-8">
                {!! Form::select('direct_department_id', $departmentsDataForForms['directDepartments'], null, ['id' => 'direct_department_id', 'class' => 'form-control select2', 'required' => true]) !!}
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('national_id') ? ' has-error' : '' }}">
            ...
            <div class="col-md-8">
                {!! Form::number('national_id', null, ['id' => 'national_id', 'class' => 'form-control', 'min' => '1000000000', 'max' => '1999999999', 'required' => true]) !!}
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('phone_number') ? ' has-error' : '' }}">
            ...
            <div class="col-md-8">
                {!! Form::number('phone_number', null, ['id' => 'phone_number', 'class' => 'form-control', 'min' => '0500000000', 'max' => '0599999999', 'required' => true]) !!}
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('job_role_id') ? ' has-error' : '' }}">
            ...
            <label for="job_role_id" class="col-md-4 control-label">
                {{ __('users::employees.job_role_id') }}
                <span style="color: red">*</span>
            </label>

            <div class="col-md-8">
                {!! Form::select('job_role_id', $rolesData, null, ['id' => 'job_role_id', 'class' => 'form-control select2', 'required' => true]) !!}
