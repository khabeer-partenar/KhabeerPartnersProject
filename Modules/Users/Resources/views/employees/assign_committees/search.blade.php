        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('employee_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('employee_id', $employeesIdsData, '', ['id' => 'employee_id', 'class' => 'form-control select2-ajax-search', 'data-ajax--url' => route('employees.assign_committees.search', [$secretaryGroupId, 'name'])]) !!}
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('national_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('national_id', $employeesNationalIdData, '', ['id' => 'national_id', 'class' => 'form-control select2-ajax-search', 'data-ajax--url' => route('employees.assign_committees.search', [$secretaryGroupId, 'national_id'])]) !!}
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('employee_email') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        {!! Form::select('employee_email', $employeesEmailData, '', ['id' => 'employee_email', 'class' => 'form-control select2-ajax-search', 'data-ajax--url' => route('employees.assign_committees.search', [$secretaryGroupId, 'email'])]) !!}
