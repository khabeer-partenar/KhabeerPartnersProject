<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('main_department_id') ? ' has-error' : '' }}">
            ...
            <div class="col-md-8">
                {!! Form::select('main_department_id', $mainDepartments, null, ['id' => 'main_department_id', 'class' => 'form-control select2', 'disabled']) !!}
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('parent_department_id') ? ' has-error' : '' }}">
            ...
            <div class="col-md-8">
                {!! Form::select('parent_department_id', $parentDepartments, null, ['id' => 'parent_department_id', 'class' => 'form-control select2', 'disabled']) !!}
